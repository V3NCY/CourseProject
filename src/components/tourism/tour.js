      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          ...
          <Typography paragraph>
            Връх Богдан (Голям Богдан) е най-високият връх в Средна гора. Той е покрит със стара букова гора, обявена за резерват през 1972 г. Върхът е сред 100-те национални туристически обекта. След опожаряването на х.Богдан, печат може да се намери само в гр.Копривщица - в туристическия информационен център и тур.спалня Войводенец. С височината на вр.Богдан от 1604 м. планината се нарежда на 10-то място в България.

            Маршрути: Връх Богдан може да бъде изкачен от гр.Копривщица по няколко маршрута. Най-популярен е вариантът по долината на Крива река, десен приток на р.Тополница, маркиран в жълт цвят (маркировката е неподдържана). В края на долината при малък заслон с чешма пътеката завива на юг и се изкачва през гъста смесена гора на Плачкова поляна. Там се появяват колове от зимна маркировка, които водят до останките на х.Богдан. Оттам до върха остават 30 минути изкачване през резервата. Общо маршрутът отнема около 3 часа.
          </Typography>
